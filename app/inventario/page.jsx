...
export default function InventarioPage() {
  ...
  async function loadAll() {
    ...
    // stock desde vista
    const { data: st, error: es } = await supabase
  ...
  async function createItem(e) {
    ...
    if (error) {
      alert("Error creando ítem: " + error.message);
      return;
    }
        ...
        <form onSubmit={createMovement} className="grid gap-3 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <Select
              ...
              onChange={(e) => setMovForm((s) => ({ ...s, item_id: e.target.value }))}
              required
            >
          ...
          <div>
            ...
            <Select
              value={movForm.mtype}
              onChange={(e) => setMovForm((s) => ({ ...s, mtype: e.target.value }))}
            >
